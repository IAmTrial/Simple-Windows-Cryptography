...
#define LICENSE_TEXT(PREFIX_MACRO) \
    { \
      PREFIX_MACRO("Simple Windows Cryptography"), \
      PREFIX_MACRO("Copyright (C) 2022  Mir Drualga"), \
      PREFIX_MACRO(""), \
      PREFIX_MACRO("This program is free software: you can redistribute it and/or modify"), \
      PREFIX_MACRO("it under the terms of the GNU Affero General Public License as"), \
      ...
      PREFIX_MACRO("Affero General Public License for more details."), \
      PREFIX_MACRO(""), \
      PREFIX_MACRO("You should have received a copy of the GNU Affero General Public"), \
